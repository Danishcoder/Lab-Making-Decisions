...
if (amysAge > brittanisAge) {
  ...
  console.log("Brittney is older")
} else {
  console.log("Amy and Brittney are the same age")
}
...
if (amysBirthYear === brittanisBirthYear) {
  console.log ("Amy and brittney were born in the same year")
} else console.log("Amy and Brittney were not born in the same year")
...
if (temperature > 80 && rain === true)
  ...
  console.log("Wear a hoodie and sweats")
